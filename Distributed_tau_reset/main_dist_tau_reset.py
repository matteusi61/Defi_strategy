...
from dist_tau_reset import DistTauResetParams, DistTauResetStrategy
...
if __name__ == '__main__':
    ...
    # Init the strategy
    params: TauResetParams = TauResetParams(BINS=3, INFO_TIME=24*30, INITIAL_BALANCE=1_000_000)
